...
<body>
    ...
    <section>
        <table border="1" width="600" cellspacing="10" cellpadding="1">
            ...
            <?php
            if (isset($_SESSION['misProductos']) && is_array($_SESSION['misProductos']) && count($_SESSION['misProductos']) > 0) {
                foreach ($_SESSION['misProductos'] as $producto) {
                    ?>
                    <tr>
                        <td><?php echo $producto['descripción']; ?></td>
                        <td><?php echo $producto['stock']; ?></td>
                        <td><?php echo '$' . (is_numeric($producto['precio']) ? number_format($producto['precio'], 2) : 'N/A'); ?></td>
                    </tr>
                    <?php
                }
            } else {
